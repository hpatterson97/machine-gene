...
5. if the critical value is less than the joint pdf of the proposed, store the proposed samples in a variable 

## Example - 2D Rejection Sampling on a Square
Here is an example of 2DRejectionSampling using the joint pdf of
